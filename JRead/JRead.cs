...
namespace JRead
{
    public static class JRead
    {
        ...
        public static string ReadWithCustomHistory(string? prefillText, JReadOptions options)
        {
            return ReadInternal(prefillText, options);
        }

        private static string ReadInternal(string? prefillText, JReadOptions options)
        {
